...
| 🚧 Protección de rutas                        | Acceso restringido a rutas según los permisos asignados al usuario.                                     |
...
| **PostgreSQL**          | Sistema de base de datos relacional utilizado para persistencia.             |
