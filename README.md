...
| Nombre            | Ruta               | Metodo | Cuerpo                                                                                          |
| ----------------- | ------------------ | ------ | ----------------------------------------------------------------------------------------------- |
| Iniciar sesión    | `auth/sign-in`     | Post   | `json { "email": "correo@ejemplo.com", "password": "123456789" } `                              |
| Crear cuenta      | `auth/signUp`      | Post   | `json { "name": "nombre-de-usuario", "email": "correo@ejemplo.com", "password": "123456789" } ` |
| Actualizar estado | `user/:id`         | Put    | none                                                                                            |
| Actualizar perfil | `user/profile/:id` | Patch  | `json { "name": "nombre-de-usuario", "email": "correo@ejemplo.com", "password": "123456789" } ` |
| Registrar Rol | `/role` | Post  | `json {"name": "client"} ` |
| Asignar permiso a usuario por ruta | `/user-route-access` | Post  | `json { "user_id": 3,"routes": ["user/:id", "user/profile/:id"]} ` |
| Asignar permiso al rol | `/role-route-access` | Post  | `json { "role_id": 3,"routes": ["user/:id", "user/profile/:id"]} ` |
