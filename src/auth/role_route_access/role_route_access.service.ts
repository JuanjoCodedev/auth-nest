...
export class RoleRouteAccessService {
  ...
  public async createRoleRouteAccess(body: RoleRouteAccessDto): Promise<Auth.ApiResponse<RoleRouteAccessEntity>> {
    ...
    const newUserRouteAccess = this._roleRouteAccessRepository.create(body);
